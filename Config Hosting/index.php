<?php
	//$conn=mysql_connect('localhost','ishalime_store','store123456') or die (mysql_error());
	//mysql_select_db('ishalime_store',$conn) or die (mysql_error());
...
define('APP_DOMAIN', 'https://ishalimedia.com/appfb/ishalistore');//Khong co dau /
define('FB_APP_DOMAIN', 'https://apps.facebook.com/ishali_media_store');

define('ROOT_DOMAIN', FB_APP_DOMAIN);

define('APP_ID', '117126145156645');
