...
function sendmail($mailfrom, $mailto, $nameto, $namefrom, $namereplay, $subject, $noidung )
{
		$mail = new PHPMailer();
		...
		$mail->SMTPSecure = 'ssl';
		$mail->Username = "hongtien510@ishali.com.vn"; // your SMTP username or your gmail username// Email gui thu
